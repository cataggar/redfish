...
///
/// This resource shall represent a resource collection of `SimpleStorage` instances for a Redfish implementation.
pub const SimpleStorageCollection = struct {
    ...
    Members: ?[]const core.NavProperty(simple_storage.SimpleStorage) = null,
