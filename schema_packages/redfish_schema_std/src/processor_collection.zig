...
///
/// This resource shall represent a resource collection of `Processor` instances for a Redfish implementation.
pub const ProcessorCollection = struct {
    ...
    Members: ?[]const core.NavProperty(processor.Processor) = null,
