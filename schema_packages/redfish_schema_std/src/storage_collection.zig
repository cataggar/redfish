...
///
/// This resource shall represent a resource collection of `Storage` instances for a Redfish implementation.
pub const StorageCollection = struct {
    ...
    Members: ?[]const core.NavProperty(storage.Storage) = null,
