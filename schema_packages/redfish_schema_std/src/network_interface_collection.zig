...
/// The collection of `NetworkInterface` resource instances.
///
/// This resource shall represent a resource collection of `NetworkInterface` instances for a Redfish implementation.
pub const NetworkInterfaceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(network_interface.NetworkInterface) = null,
