//! Namespace `RouteEntryCollection`.
//!
...
const route_entry = @import("route_entry.zig");
const settings = @import("settings.zig");

/// The collection of `RouteEntry` resource instances.
///
/// This resource shall represent a resource collection of `RouteEntry` instances for a Redfish implementation.
pub const RouteEntryCollection = struct {
    ...
    Members: ?[]const core.NavProperty(route_entry.RouteEntry) = null,
