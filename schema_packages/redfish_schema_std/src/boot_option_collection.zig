//! Namespace `BootOptionCollection`.
//!
...
const boot_option = @import("boot_option.zig");
const resource = @import("resource.zig");
const settings = @import("settings.zig");

/// The collection of `BootOption` resource instances.
///
/// This resource shall represent a resource collection of `BootOption` instances for a Redfish implementation.
pub const BootOptionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(boot_option.BootOption) = null,
