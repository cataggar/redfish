//! Namespace `JobDocumentCollection`.
//!
...
/// The collection of `JobDocument` resource instances.
///
/// This resource shall represent a resource collection of `JobDocument` instances for a Redfish implementation.
pub const JobDocumentCollection = struct {
    ...
    Members: ?[]const core.NavProperty(job_document.JobDocument) = null,
