//! Namespace `PowerSupplyCollection`.
//!
...
///
/// This resource shall represent a resource collection of `PowerSupply` instances for a Redfish implementation.
pub const PowerSupplyCollection = struct {
    ...
    Members: ?[]const core.NavProperty(power_supply.PowerSupply) = null,
};
