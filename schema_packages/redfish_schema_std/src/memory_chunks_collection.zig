//! Namespace `MemoryChunksCollection`.
//!
...
///
/// This resource shall represent a resource collection of `MemoryChunks` instances for a Redfish implementation.
pub const MemoryChunksCollection = struct {
    ...
    Members: ?[]const core.NavProperty(memory_chunks.MemoryChunks) = null,
};
