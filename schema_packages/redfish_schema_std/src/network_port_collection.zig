//! Namespace `NetworkPortCollection`.
//!
...
///
/// This resource shall represent a resource collection of `NetworkPort` instances for a Redfish implementation.
///
/// Deprecated in 2020.4.
/// This schema has been deprecated in favor of the `PortCollection` schema.
pub const NetworkPortCollection = struct {
    ...
    Members: ?[]const core.NavProperty(network_port.NetworkPort) = null,
