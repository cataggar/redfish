//! Namespace `MemoryRegionCollection`.
//!
...
/// The collection of `MemoryRegion` resource instances.
///
/// This resource shall represent a resource collection of `MemoryRegion` instances for a Redfish implementation.
pub const MemoryRegionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(memory_region.MemoryRegion) = null,
