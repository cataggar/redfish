//! Namespace `AccelerationFunctionCollection`.
//!
...
///
/// This resource shall represent a resource collection of `AccelerationFunction` instances for a Redfish implementation.
pub const AccelerationFunctionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(acceleration_function.AccelerationFunction) = null,
