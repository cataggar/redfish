//! Namespace `ExternalAccountProviderCollection`.
//!
...
const external_account_provider = @import("external_account_provider.zig");
const resource = @import("resource.zig");

/// The collection of `ExternalAccountProvider` resource instances.
///
/// This resource shall represent a resource collection of `ExternalAccountProvider` instances for a Redfish implementation.
pub const ExternalAccountProviderCollection = struct {
    ...
    Members: ?[]const core.NavProperty(external_account_provider.ExternalAccountProvider) = null,
