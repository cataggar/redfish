...
///
/// This resource shall represent a resource collection of `VLanNetworkInterface` instances for a Redfish implementation.
pub const VlanNetworkInterfaceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(vlan_network_interface.VlanNetworkInterface) = null,
};
