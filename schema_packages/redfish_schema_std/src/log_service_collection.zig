...
///
/// This resource shall represent a resource collection of `LogService` instances for a Redfish implementation.
pub const LogServiceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(log_service.LogService) = null,
