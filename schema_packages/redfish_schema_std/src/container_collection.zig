...
/// The collection of `Container` resource instances.
///
/// This resource shall represent a resource collection of `Container` instances for a Redfish implementation.
pub const ContainerCollection = struct {
    ...
    Members: ?[]const core.NavProperty(container.Container) = null,
};
