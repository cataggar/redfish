...
const vcat_entry = @import("vcat_entry.zig");

/// The collection of `VCATEntry` resource instances.
///
/// This resource shall represent a resource collection of `VCATEntry` instances for a Redfish implementation.
pub const VcatEntryCollection = struct {
    ...
    Members: ?[]const core.NavProperty(vcat_entry.VcatEntry) = null,
