//! Namespace `GraphicsControllerCollection`.
//!
...
///
/// This resource shall represent a resource collection of `GraphicsController` instances for a Redfish implementation.
pub const GraphicsControllerCollection = struct {
    ...
    Members: ?[]const core.NavProperty(graphics_controller.GraphicsController) = null,
