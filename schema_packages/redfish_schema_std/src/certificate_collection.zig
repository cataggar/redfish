//! Namespace `CertificateCollection`.
//!
...
///
/// This resource shall represent a resource collection of `Certificate` instances for a Redfish implementation.
pub const CertificateCollection = struct {
    ...
    Members: ?[]const core.NavProperty(certificate.Certificate) = null,
