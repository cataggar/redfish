//! Namespace `CXLLogicalDeviceCollection`.
//!
...
/// The collection of `CXLLogicalDevice` resource instances.
///
/// This resource shall represent a resource collection of `CXLLogicalDevice` instances for a Redfish implementation.
pub const CxlLogicalDeviceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(cxl_logical_device.CxlLogicalDevice) = null,
