//! Namespace `MetricDefinitionCollection`.
//!
...
///
/// This resource shall represent a resource collection of `MetricDefinition` instances for a Redfish implementation.
pub const MetricDefinitionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(metric_definition.MetricDefinition) = null,
