...
///
/// This resource shall represent a resource collection of `Pump` instances for a Redfish implementation.
pub const PumpCollection = struct {
    ...
    Members: ?[]const core.NavProperty(pump.Pump) = null,
