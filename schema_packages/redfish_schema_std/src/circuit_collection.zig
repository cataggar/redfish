...
///
/// This resource shall represent a resource collection of `Circuit` instances for a Redfish implementation.
pub const CircuitCollection = struct {
    ...
    Members: ?[]const core.NavProperty(circuit.Circuit) = null,
