//! Namespace `ResourceBlockCollection`.
//!
...
///
/// This resource shall represent a resource collection of `ResourceBlock` instances for a Redfish implementation.
pub const ResourceBlockCollection = struct {
    ...
    Members: ?[]const core.NavProperty(resource_block.ResourceBlock) = null,
};
