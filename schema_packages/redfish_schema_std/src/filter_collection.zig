...
/// The collection of `Filter` resource instances.
///
/// This resource shall represent a resource collection of `Filter` instances for a Redfish implementation.
pub const FilterCollection = struct {
    ...
    Members: ?[]const core.NavProperty(filter.Filter) = null,
