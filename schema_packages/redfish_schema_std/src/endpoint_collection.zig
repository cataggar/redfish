...
///
/// This resource shall represent a resource collection of `Endpoint` instances for a Redfish implementation.
pub const EndpointCollection = struct {
    ...
    Members: ?[]const core.NavProperty(endpoint.Endpoint) = null,
};
