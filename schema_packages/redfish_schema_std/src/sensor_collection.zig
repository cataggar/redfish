...
///
/// This resource shall represent a resource collection of `Sensor` instances for a Redfish implementation.
pub const SensorCollection = struct {
    ...
    Members: ?[]const core.NavProperty(sensor.Sensor) = null,
