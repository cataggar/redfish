...
///
/// This resource shall represent a resource collection of `License` instances for a Redfish implementation.
pub const LicenseCollection = struct {
    ...
    Members: ?[]const core.NavProperty(license.License) = null,
};
