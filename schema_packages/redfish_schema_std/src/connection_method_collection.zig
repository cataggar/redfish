//! Namespace `ConnectionMethodCollection`.
//!
...
///
/// This resource shall represent a resource collection of `ConnectionMethod` instances for a Redfish implementation.
pub const ConnectionMethodCollection = struct {
    ...
    Members: ?[]const core.NavProperty(connection_method.ConnectionMethod) = null,
