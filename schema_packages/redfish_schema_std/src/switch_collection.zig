...
///
/// This resource shall represent a resource collection of `Switch` instances for a Redfish implementation.
pub const SwitchCollection = struct {
    ...
    Members: ?[]const core.NavProperty(@"switch".Switch) = null,
