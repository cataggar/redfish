//! Namespace `ComputerSystemCollection`.
//!
...
///
/// This resource shall represent a resource collection of `ComputerSystem` instances for a Redfish implementation.
pub const ComputerSystemCollection = struct {
