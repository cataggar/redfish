//! Namespace `MetricReportCollection`.
//!
...
///
/// This resource shall represent a resource collection of `MetricReport` instances for a Redfish implementation.
pub const MetricReportCollection = struct {
    ...
    Members: ?[]const core.NavProperty(metric_report.MetricReport) = null,
