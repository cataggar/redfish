...
///
/// This resource shall represent a resource collection of `SerialInterface` instances for a Redfish implementation.
pub const SerialInterfaceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(serial_interface.SerialInterface) = null,
