...
///
/// This resource shall represent a resource collection of `Battery` instances for a Redfish implementation.
pub const BatteryCollection = struct {
    ...
    Members: ?[]const core.NavProperty(battery.Battery) = null,
