//! Namespace `OutletGroupCollection`.
//!
...
const outlet_group = @import("outlet_group.zig");
const resource = @import("resource.zig");
const settings = @import("settings.zig");

/// The collection of `OutletGroup` resource instances.
///
/// This resource shall represent a resource collection of `OutletGroup` instances for a Redfish implementation.
pub const OutletGroupCollection = struct {
    ...
    Members: ?[]const core.NavProperty(outlet_group.OutletGroup) = null,
