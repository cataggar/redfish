//! Namespace `PowerDomainCollection`.
//!
...
const power_domain = @import("power_domain.zig");
const resource = @import("resource.zig");

/// The collection of `PowerDomain` resource instances.
///
/// This resource shall represent a resource collection of `PowerDomain` instances for a Redfish implementation.
pub const PowerDomainCollection = struct {
    ...
    Members: ?[]const core.NavProperty(power_domain.PowerDomain) = null,
};
