//! Namespace `CompositionReservationCollection`.
//!
...
const composition_reservation = @import("composition_reservation.zig");
const resource = @import("resource.zig");

/// The collection of `CompositionReservation` resource instances.
///
/// This resource shall represent a resource collection of `CompositionReservation` instances for a Redfish implementation.
pub const CompositionReservationCollection = struct {
    ...
    Members: ?[]const core.NavProperty(composition_reservation.CompositionReservation) = null,
