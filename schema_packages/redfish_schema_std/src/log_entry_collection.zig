...
///
/// This resource shall represent a resource collection of `LogEntry` instances for a Redfish implementation.
pub const LogEntryCollection = struct {
    ...
    Members: ?[]const core.NavProperty(log_entry.LogEntry) = null,
