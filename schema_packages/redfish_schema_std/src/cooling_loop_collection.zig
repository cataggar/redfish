//! Namespace `CoolingLoopCollection`.
//!
...
/// The collection of `CoolingLoop` resource instances.
///
/// This resource shall represent a resource collection of `CoolingLoop` instances for a Redfish implementation.
pub const CoolingLoopCollection = struct {
    ...
    Members: ?[]const core.NavProperty(cooling_loop.CoolingLoop) = null,
