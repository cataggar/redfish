//! Namespace `NetworkAdapterCollection`.
//!
...
///
/// This resource shall represent a resource collection of `NetworkAdapter` instances for a Redfish implementation.
pub const NetworkAdapterCollection = struct {
    ...
    Members: ?[]const core.NavProperty(network_adapter.NetworkAdapter) = null,
