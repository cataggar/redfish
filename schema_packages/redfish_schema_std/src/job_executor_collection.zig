//! Namespace `JobExecutorCollection`.
//!
...
/// The collection of `JobExecutor` resource instances.
///
/// This resource shall represent a resource collection of `JobExecutor` instances for a Redfish implementation.
pub const JobExecutorCollection = struct {
    ...
    Members: ?[]const core.NavProperty(job_executor.JobExecutor) = null,
