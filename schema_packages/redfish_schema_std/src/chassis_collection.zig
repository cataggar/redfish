...
///
/// This resource shall represent a resource collection of `Chassis` instances for a Redfish implementation.
pub const ChassisCollection = struct {
    ...
    Members: ?[]const core.NavProperty(chassis.Chassis) = null,
