...
///
/// This resource shall represent a resource collection of `Memory` instances for a Redfish implementation.
pub const MemoryCollection = struct {
    ...
    Members: ?[]const core.NavProperty(memory.Memory) = null,
