...
///
/// This resource shall represent a resource collection of `Triggers` instances for a Redfish implementation.
pub const TriggersCollection = struct {
    ...
    Members: ?[]const core.NavProperty(triggers.Triggers) = null,
