//! Namespace `ManagerAccountCollection`.
//!
...
///
/// This resource shall represent a resource collection of `ManagerAccount` instances for a Redfish implementation.
pub const ManagerAccountCollection = struct {
    ...
    Members: ?[]const core.NavProperty(manager_account.ManagerAccount) = null,
};
