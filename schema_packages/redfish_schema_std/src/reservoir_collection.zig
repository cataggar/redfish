...
const reservoir = @import("reservoir.zig");
const resource = @import("resource.zig");

/// The collection of `Reservoir` resource instances.
///
/// This resource shall represent a resource collection of `Reservoir` instances for a Redfish implementation.
pub const ReservoirCollection = struct {
    ...
    Members: ?[]const core.NavProperty(reservoir.Reservoir) = null,
