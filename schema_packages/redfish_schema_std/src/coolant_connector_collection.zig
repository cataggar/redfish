//! Namespace `CoolantConnectorCollection`.
//!
...
const coolant_connector = @import("coolant_connector.zig");
const resource = @import("resource.zig");
const settings = @import("settings.zig");

/// The collection of `CoolantConnector` resource instances.
///
/// This resource shall represent a resource collection of `CoolantConnector` instances for a Redfish implementation.
pub const CoolantConnectorCollection = struct {
    ...
    Members: ?[]const core.NavProperty(coolant_connector.CoolantConnector) = null,
