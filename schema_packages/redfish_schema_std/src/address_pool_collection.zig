//! Namespace `AddressPoolCollection`.
//!
...
///
/// This resource shall represent a resource collection of `AddressPool` instances for a Redfish implementation.
pub const AddressPoolCollection = struct {
    ...
    Members: ?[]const core.NavProperty(address_pool.AddressPool) = null,
