...
///
/// This resource shall represent a resource collection of `Manager` instances for a Redfish implementation.
pub const ManagerCollection = struct {
    ...
    Members: ?[]const core.NavProperty(manager.Manager) = null,
