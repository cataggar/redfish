...
///
/// This resource shall represent a resource collection of `EthernetInterface` instances for a Redfish implementation.
pub const EthernetInterfaceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(ethernet_interface.EthernetInterface) = null,
