...
const virtual_media = @import("virtual_media.zig");

/// The collection of `VirtualMedia` resource instances.
///
/// This resource shall represent a resource collection of `VirtualMedia` instances for a Redfish implementation.
pub const VirtualMediaCollection = struct {
    ...
    Members: ?[]const core.NavProperty(virtual_media.VirtualMedia) = null,
