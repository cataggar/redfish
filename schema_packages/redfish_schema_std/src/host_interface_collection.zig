//! Namespace `HostInterfaceCollection`.
//!
...
///
/// This resource shall represent a resource collection of `HostInterface` instances for a Redfish implementation.
pub const HostInterfaceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(host_interface.HostInterface) = null,
