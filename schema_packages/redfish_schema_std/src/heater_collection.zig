...
/// The collection of `Heater` resource instances.
///
/// This resource shall represent a resource collection of `Heater` instances for a Redfish implementation.
pub const HeaterCollection = struct {
    ...
    Members: ?[]const core.NavProperty(heater.Heater) = null,
