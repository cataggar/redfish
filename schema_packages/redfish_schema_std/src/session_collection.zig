...
///
/// This resource shall represent a resource collection of `Session` instances for a Redfish implementation.
pub const SessionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(session.Session) = null,
