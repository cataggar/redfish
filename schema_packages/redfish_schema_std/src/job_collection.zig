...
///
/// This resource shall represent a resource collection of `Job` instances for a Redfish implementation.
pub const JobCollection = struct {
    ...
    Members: ?[]const core.NavProperty(job.Job) = null,
