...
///
/// This resource shall represent a resource collection of `Connection` instances for a Redfish implementation.
pub const ConnectionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(connection.Connection) = null,
};
