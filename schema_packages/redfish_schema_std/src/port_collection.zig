...
///
/// This resource shall represent a resource collection of `Port` instances for a Redfish implementation.
pub const PortCollection = struct {
    ...
    Members: ?[]const core.NavProperty(port.Port) = null,
};
