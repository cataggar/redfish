//! Namespace `PowerDistributionCollection`.
//!
...
///
/// This resource shall represent a resource collection of `PowerDistribution` instances for a Redfish implementation.
pub const PowerDistributionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(power_distribution.PowerDistribution) = null,
