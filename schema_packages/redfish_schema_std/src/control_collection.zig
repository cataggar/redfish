...
///
/// This resource shall represent a resource collection of `Control` instances for a Redfish implementation.
pub const ControlCollection = struct {
    ...
    Members: ?[]const core.NavProperty(control.Control) = null,
};
