...
///
/// This resource shall represent a resource collection of `Outlet` instances for a Redfish implementation.
pub const OutletCollection = struct {
    ...
    Members: ?[]const core.NavProperty(outlet.Outlet) = null,
