...
///
/// This resource shall represent a resource collection of `Facility` instances for a Redfish implementation.
pub const FacilityCollection = struct {
    ...
    Members: ?[]const core.NavProperty(facility.Facility) = null,
