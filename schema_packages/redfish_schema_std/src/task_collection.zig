...
///
/// This resource shall represent a resource collection of `Task` instances for a Redfish implementation.
pub const TaskCollection = struct {
    ...
    Members: ?[]const core.NavProperty(task.Task) = null,
