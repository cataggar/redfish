...
///
/// This resource shall represent a resource collection of `Role` instances for a Redfish implementation.
pub const RoleCollection = struct {
    ...
    Members: ?[]const core.NavProperty(role.Role) = null,
};
