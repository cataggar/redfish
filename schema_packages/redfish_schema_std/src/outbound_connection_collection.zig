//! Namespace `OutboundConnectionCollection`.
//!
...
/// The collection of `OutboundConnection` resource instances.
///
/// This resource shall represent a resource collection of `OutboundConnection` instances for a Redfish implementation.
pub const OutboundConnectionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(outbound_connection.OutboundConnection) = null,
