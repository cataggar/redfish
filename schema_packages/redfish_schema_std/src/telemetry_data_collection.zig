//! Namespace `TelemetryDataCollection`.
//!
...
/// The collection of `TelemetryData` resource instances.
///
/// This resource shall represent a resource collection of `TelemetryData` instances for a Redfish implementation.
pub const TelemetryDataCollection = struct {
    ...
    Members: ?[]const core.NavProperty(telemetry_data.TelemetryData) = null,
