//! Namespace `ContainerImageCollection`.
//!
...
/// The collection of `ContainerImage` resource instances.
///
/// This resource shall represent a resource collection of `ContainerImage` instances for a Redfish implementation.
pub const ContainerImageCollection = struct {
    ...
    Members: ?[]const core.NavProperty(container_image.ContainerImage) = null,
