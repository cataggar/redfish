//! Namespace `MemoryExtentCollection`.
//!
...
/// The collection of `MemoryExtent` resource instances.
///
/// This resource shall represent a resource collection of `MemoryExtent` instances for a Redfish implementation.
pub const MemoryExtentCollection = struct {
    ...
    Members: ?[]const core.NavProperty(memory_extent.MemoryExtent) = null,
