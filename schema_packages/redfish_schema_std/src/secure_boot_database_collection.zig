//! Namespace `SecureBootDatabaseCollection`.
//!
...
const secure_boot_database = @import("secure_boot_database.zig");
const settings = @import("settings.zig");

/// The collection of `SecureBootDatabase` resource instances.
///
/// This resource shall represent a resource collection of `SecureBootDatabase` instances for a Redfish implementation.
pub const SecureBootDatabaseCollection = struct {
    ...
    Members: ?[]const core.NavProperty(secure_boot_database.SecureBootDatabase) = null,
