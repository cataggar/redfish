//! Namespace `FabricAdapterCollection`.
//!
...
///
/// This resource shall represent a resource collection of `FabricAdapter` instances for a Redfish implementation.
pub const FabricAdapterCollection = struct {
    ...
    Members: ?[]const core.NavProperty(fabric_adapter.FabricAdapter) = null,
