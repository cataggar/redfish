...
///
/// This resource shall represent a resource collection of `Cable` instances for a Redfish implementation.
pub const CableCollection = struct {
    ...
    Members: ?[]const core.NavProperty(cable.Cable) = null,
