...
///
/// This resource shall represent a resource collection of `Fan` instances for a Redfish implementation.
pub const FanCollection = struct {
    ...
    Members: ?[]const core.NavProperty(fan.Fan) = null,
