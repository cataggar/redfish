//! Namespace `OperatingConfigCollection`.
//!
...
///
/// This resource shall represent a resource collection of `OperatingConfig` instances for a Redfish implementation.
pub const OperatingConfigCollection = struct {
    ...
    Members: ?[]const core.NavProperty(operating_config.OperatingConfig) = null,
