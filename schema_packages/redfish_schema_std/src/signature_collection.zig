...
///
/// This resource shall represent a resource collection of `Signature` instances for a Redfish implementation.
pub const SignatureCollection = struct {
    ...
    Members: ?[]const core.NavProperty(signature.Signature) = null,
