//! Namespace `PCIeDeviceCollection`.
//!
...
///
/// This resource shall represent a resource collection of `PCIeDevice` instances for a Redfish implementation.
pub const PcieDeviceCollection = struct {
    ...
    Members: ?[]const core.NavProperty(pcie_device.PcieDevice) = null,
