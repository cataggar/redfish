//! Namespace `CertificateEnrollmentCollection`.
//!
...
/// The collection of `CertificateEnrollment` resource instances.
///
/// This resource shall represent a resource collection of `CertificateEnrollment` instances for a Redfish implementation.
pub const CertificateEnrollmentCollection = struct {
    ...
    Members: ?[]const core.NavProperty(certificate_enrollment.CertificateEnrollment) = null,
