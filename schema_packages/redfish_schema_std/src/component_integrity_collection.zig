//! Namespace `ComponentIntegrityCollection`.
//!
...
///
/// This resource shall represent a resource collection of `ComponentIntegrity` instances for a Redfish implementation.
pub const ComponentIntegrityCollection = struct {
    ...
    Members: ?[]const core.NavProperty(component_integrity.ComponentIntegrity) = null,
