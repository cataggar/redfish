//! Namespace `LeakDetectorCollection`.
//!
...
/// The collection of `LeakDetector` resource instances.
///
/// This resource shall represent a resource collection of `LeakDetector` instances for a Redfish implementation.
pub const LeakDetectorCollection = struct {
    ...
    Members: ?[]const core.NavProperty(leak_detector.LeakDetector) = null,
