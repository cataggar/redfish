...
///
/// This resource shall represent a resource collection of `Aggregate` instances for a Redfish implementation.
pub const AggregateCollection = struct {
    ...
    Members: ?[]const core.NavProperty(aggregate.Aggregate) = null,
