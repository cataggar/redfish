...
///
/// This resource shall represent a resource collection of `Zone` instances for a Redfish implementation.
pub const ZoneCollection = struct {
    ...
    Members: ?[]const core.NavProperty(zone.Zone) = null,
