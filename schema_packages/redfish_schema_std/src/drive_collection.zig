...
///
/// This resource shall represent a resource collection of `Drive` instances for a Redfish implementation.
pub const DriveCollection = struct {
    ...
    Members: ?[]const core.NavProperty(drive.Drive) = null,
