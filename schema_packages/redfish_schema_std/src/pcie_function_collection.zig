//! Namespace `PCIeFunctionCollection`.
//!
...
///
/// This resource shall represent a resource collection of `PCIeFunction` instances for a Redfish implementation.
pub const PcieFunctionCollection = struct {
    ...
    Members: ?[]const core.NavProperty(pcie_function.PcieFunction) = null,
};
